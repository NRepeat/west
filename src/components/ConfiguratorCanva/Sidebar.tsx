    ...
    return (
        <div className="flex gap-2 flex-col overflow-auto  ">
            ...
            <div className={clsx('grid  grid-cols-2  gap-2')}>
                {products.map((product: DiskModel, index: number) => (
        ...
        <HoverCard>
            <HoverCardTrigger asChild>
                <Card
                    ...
                    className={clsx(
                        'hover:border-input border-2 border-white rounded-sm overflow-hidden p-2.5 cursor-pointer',
                        { 'border-input cursor-default': index === selectedIndex },
                    )}
                >
