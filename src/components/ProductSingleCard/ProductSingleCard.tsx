...
const ProductSingleCard = () => {
  ...
  return (
    <UiComponentContainer
      className={clsx('min-h-s', { 'select-none': isPointerDown })}
    >
      <div className='grid gap-4 grid-cols-12 grid-row-6 p-2.5'>
        <div className='col-span-4 relative max-w-[650px] rounded-md overflow-hidden'>
          ...
          {isComponentVisible ? (
            <Suspense
              fallback={<DLoader height={400} width={200} isResponsive />}
            >
        ...
        <div className='col-start-5 col-span-4 grid-flow-col min-w-[300px]'>
          ...
          <div className='pt-4 text-lg'>
            ...
            labore excepturi magnam earum aspernatur sed ut officia reiciendis
            impedit iure, porro id rerum repellendus explicabo mollitia cumque
            autem! Esse, laudantium.
          </div>
        </div>
