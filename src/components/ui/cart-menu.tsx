  ...
  return (
    <div className='flex gap-4 justify-end px-2.5'>
      <SheetMenu
        ...
        trigger={<div className='font-SignPainter flex justify-start items-center'>
          <Button variant={'ghost'}>
            <Icon src={CartIcon} height='30' width='30' alt='cart-icon' />
          </Button>
        </div>}
      >
        <CartMenuCard img={AudiImg} price={200} quantity={4} slug='Anthracite-8.5-J-x-20-Audi-Q6' title='Audi' />
...
const CartButton = ({ price }: { price: number }) => <div className='w-full flex items-center justify-center '>
  <Button className='flex p-0 gap-0 w-4/5 rounded-sm overflow-hidden h-16' variant={'success'}>
    <p className='flex text-center justify-center w-full'>
      Process checkout
    </p>
