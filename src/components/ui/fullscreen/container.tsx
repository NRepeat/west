import { DndContext, KeyboardSensor, MouseSensor, TouchSensor, UniqueIdentifier, useDraggable, useSensor, useSensors } from '@dnd-kit/core';
...
const Container: FC<ContainerProps> = (props) => {
	...
	const updateItemCoordinates = (id: UniqueIdentifier, x: number, y: number, perv: ItemCoordinates[]) => {
