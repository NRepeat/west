...
const MainCanvas = () => {
	...
	return (
		<div className="canvas relative w-full h-screen">
			<Canvas shadows camera={{ position: new THREE.Vector3(15, 0, 12), fov: 30 }} dpr={[1, 22]}  >
				<OrbitControls />
				<spotLight position={[2, 12, 3]} angle={2} penumbra={1} castShadow intensity={2} shadow-bias={-0.02} />
		...
		<>
			...
			<mesh scale={100}>
				...
				<LayerMaterial side={THREE.BackSide}>
					...
					<Depth colorA="#211A1F" colorB="" alpha={0.5} mode="normal" near={10} far={400} origin={[100, 100, 100]} />
				</LayerMaterial>
			</mesh>
		</>
	)
