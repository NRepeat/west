...
export const useBoxStore = create<UseDiskStoreT>((set) => ({
    disks: [
        {
            name: 'Anthracite-8.5-J-x-20-Audi-Q1',
            path: 'model/Disk1/disk.gltf',
            title: 'Anthracite 8.5 J x 20 Audi Q1',
            props: {
        ...
        {
            name: 'Anthracite-8.5-J-x-20-Audi-Q2',
            path: 'model/Disk2/disk.gltf',
            title: 'Anthracite 8.5 J x 20 Audi Q2',
            props: {
                color: { code: '43464B', name: 'Gray', slug: 'gray' },
                diameter: 'R20',
                et: 'ER35',
        ...
        {
            name: 'Anthracite-8.5-J-x-20-Audi-Q6',
            path: 'model/Disk2/disk.gltf',
